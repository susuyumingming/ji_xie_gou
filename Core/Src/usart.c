...
void MX_UART8_Init(void)
{
  ...
  */
  ...
  /* UART8_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_2, LL_DMAMUX1_REQ_UART8_RX);
...
void MX_USART1_UART_Init(void)
{
  ...
  */
  ...
  /* USART1_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_5, LL_DMAMUX1_REQ_USART1_RX);
...
void MX_USART2_UART_Init(void)
{
  ...
  */
  ...
  /* USART2_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_STREAM_7, LL_DMAMUX1_REQ_USART2_RX);
...
void MX_USART3_UART_Init(void)
{
  ...
  */
  ...
  /* USART3_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_3, LL_DMAMUX1_REQ_USART3_RX);
