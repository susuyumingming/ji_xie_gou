...
// #define PEN  		PEin(7)  	//T_PEN
//#define DOUT 		PBin(8)   	//T_MISO
//#define TDIN 		PFout(11)  	//T_MOSI
//#define TCLK 		PBout(0)  	//T_SCK
// #define TCS  		PGout(8)  	//T_CS  
#define	TCS_SET	LL_GPIO_SetOutputPin(GPIOG, LL_GPIO_PIN_8)//片选端口						    
#define	TCS_CLR  LL_GPIO_ResetOutputPin(GPIOG, LL_GPIO_PIN_8)//片选端口  	PB11
