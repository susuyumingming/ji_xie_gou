...
// #define LED  8        //背光控制引脚
// #define CS   4       //片选引脚
// #define RS   3       //寄存器/数据选择引脚  
// #define RST  2       //复位引脚

//QDtech全系列模块采用了三极管控制背光亮灭，用户也可以接PWM调节背光亮度
// #define	LCD_LED PAout(LED) //LCD背光    		 
// #define LCD_CS  PFout(CS)
// #define LCD_RS  PDout(RS)
// #define LCD_RST PFout(RST)
//如果使用官方库函数定义下列底层，速度将会下降到14帧每秒，建议采用我司推荐方法
//以下IO定义直接操作寄存器，快速IO操作，刷屏速率可以达到28帧每秒！ 

#define	LCD_CS_SET	LL_GPIO_SetOutputPin(GPIOF, LL_GPIO_PIN_4)//片选端口
#define	LCD_RS_SET	LL_GPIO_SetOutputPin(GPIOD, LL_GPIO_PIN_3)//数据/命令
#define	LCD_RST_SET	LL_GPIO_SetOutputPin(GPIOF, LL_GPIO_PIN_2)//复位
 							    
#define	LCD_CS_CLR  LL_GPIO_ResetOutputPin(GPIOF, LL_GPIO_PIN_4)//片选端口  	PB11
#define	LCD_RS_CLR	LL_GPIO_ResetOutputPin(GPIOD, LL_GPIO_PIN_3)//数据/命令  PB10	 
#define	LCD_RST_CLR	LL_GPIO_ResetOutputPin(GPIOF, LL_GPIO_PIN_2)//复位			  PB12
